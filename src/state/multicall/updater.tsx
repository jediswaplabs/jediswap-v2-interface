import { Contract, FunctionAbi, num, hash, uint256, BigNumberish } from 'starknet'
import { useEffect, useMemo, useRef, useState } from 'react'
import { useDispatch, useSelector } from 'react-redux'
import { useMulticallContract } from 'hooks/useContractV2'
...
export function activeListeningKeys(
  allListeners: AppState['starkmulticall']['callListeners'],
  chainId?: ChainId
...
export function outdatedListeningKeys(
  callResults: AppState['starkmulticall']['callResults'],
...
export default function Updater(): null {
  ...
  const state = useSelector<AppState, AppState['starkmulticall']>((state) => state.starkmulticall)
