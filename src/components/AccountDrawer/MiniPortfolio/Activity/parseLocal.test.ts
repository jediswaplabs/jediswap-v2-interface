...
import { TransactionStatus as MockTxStatus } from 'graphql/data/types-and-hooks';
import { ChainTokenMap } from 'hooks/Tokens';
import { ExactInputSwapTransactionInfo,
  ExactOutputSwapTransactionInfo,
  TransactionDetails,
  TransactionInfo,
  TransactionType as MockTxType } from 'state/transactions/types';
