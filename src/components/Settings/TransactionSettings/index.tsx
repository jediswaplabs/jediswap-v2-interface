...
const OptionCustom = styled(FancyButton)<{ active?: boolean; warning?: boolean }>`
  ...
  padding: 0 0.75rem;
  flex: 1;
  border: ${({ theme, active, warning }) => active && `1px solid ${warning ? theme.signalRed : theme.jediBlue}`};
  :hover {
    border: ${({ theme, active, warning }) =>
      active && `1px solid ${warning ? darken(0.1, theme.signalRed) : darken(0.1, theme.jediBlue)}`};
  }
