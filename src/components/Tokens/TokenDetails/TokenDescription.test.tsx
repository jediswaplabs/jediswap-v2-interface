...
import { Chain, Exact, TokenProjectQuery, useTokenProjectQuery } from 'graphql/data/types-and-hooks';
...
jest.mock('graphql/data/types-and-hooks', () => {
  const originalModule = jest.requireActual('graphql/data/types-and-hooks');
  return {
    ...originalModule,
