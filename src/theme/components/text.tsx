...
export const ThemedText = {
  ...
  BodySmall(props: TextProps) {
    return <TextWrapper fontWeight={400} fontSize={14} color="neutral1" {...props} />;
  },
  HeadlineSmall(props: TextProps) {
    return <TextWrapper fontWeight={400} fontSize={20} lineHeight="28px" color="neutral1" {...props} />;
  },
  HeadlineMedium(props: TextProps) {
    return <TextWrapper fontWeight={400} fontSize={28} color="neutral1" {...props} />;
  },
  HeadlineLarge(props: TextProps) {
    return <TextWrapper fontWeight={400} fontSize={36} lineHeight="44px" color="neutral1" {...props} />;
  },
  LargeHeader(props: TextProps) {
    return <TextWrapper fontWeight={400} fontSize={36} color="neutral1" {...props} />;
  },
  Hero(props: TextProps) {
    return <TextWrapper fontWeight={400} fontSize={48} color="neutral1" {...props} />;
  },
  ...
  Link(props: TextProps) {
    return <TextWrapper fontWeight={400} fontSize={14} color="accent1" {...props} />;
  },
  ...
  DeprecatedLabel(props: TextProps) {
    return <TextWrapper fontWeight={400} color="neutral1" {...props} />;
  },
  ...
  DeprecatedYellow(props: TextProps) {
    return <TextWrapper fontWeight={400} color="deprecated_yellow3" {...props} />;
  },
  DeprecatedDarkGray(props: TextProps) {
    return <TextWrapper fontWeight={400} color="neutral2" {...props} />;
  },
  DeprecatedGray(props: TextProps) {
    return <TextWrapper fontWeight={400} color="surface2" {...props} />;
  },
  DeprecatedItalic(props: TextProps) {
    return <TextWrapper fontWeight={400} fontSize={12} fontStyle="italic" color="neutral2" {...props} />;
  },
  DeprecatedError({ error, ...props }: { error: boolean } & TextProps) {
    return <TextWrapper fontWeight={400} color={error ? 'critical' : 'neutral2'} {...props} />;
  },
};
