...
describe('position page', () => {
  it('correctly collects the correct amount', () => {
    mocked(useV3Positions.useV3PositionFromTokenId).mockImplementation(() => ({ loading: false, position: positionDetails }));
    ...
    mocked(usePool).mockImplementation(() => [PoolState.EXISTS, pool]);
    mocked(useV3PositionFees).mockImplementation(() => [USDC_AMOUNT, WETH_AMOUNT]);
